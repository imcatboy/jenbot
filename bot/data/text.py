...
MUTE_USER_SUCCESS = (
    "🔇 Пользователь <b>{0}</b> замьючен до <b>{1}</b>\n\n<b>Причина</b>\n<blockquote>{2}</blockquote>."
)
...
REPORT_ATTACHMENTS_MESSAGE = "📎 Прикрепите фото или видео до 40 МБ одним сообщением (если есть)."
...
REPORT_USERNAME_MESSAGE = (
    "🔍 Я ранее не видел этого пользователя. Введите его username, если есть, иначе пропустите."
)
THROTTLE_ERROR = "⏳ Пожалуйста, не спамьте."
REPORT_SUCCESS = (
    "🔍 Отправлено успешно. В случае ответа вам будет отправлено уведомление."
)
REPORT_WITH_ATTACHMENTS_SUCCESS = f"🔍 Отправлено успешно с {0} медиа. В случае ответа вам будет отправлено уведомление."
