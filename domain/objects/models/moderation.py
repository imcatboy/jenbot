...
from sqlalchemy import ARRAY, BigInteger, Enum, ForeignKey, Index, String
...
class ChatViolationModel(EntityModel):
    ...
    __table_args__ = (
        Index("ix_chat_violations_telegram_chat_id", "user_id", "telegram_chat_id"),
    )
...
class ReputationRequestModel(EntityModel):
